...
$sql = "SELECT `RID`, `DEPARTMENT_ID`, `KPI_USER`, `1Q_RESULT`, `1Q_SCORE`, `1Q_GRADE`, `2Q_RESULT`, `2Q_SCORE`, `2Q_GRADE`, `3Q_RESULT`, `3Q_SCORE`, `3Q_GRADE`, `4Q_RESULT`, `4Q_SCORE`, `4Q_GRADE`, `FINAL_RESULT`, `FINAL_SCORE`, `FINAL_GRADE` FROM `kpi_masterlist` WHERE CONCAT(RID, COALESCE(DELETED_AT, '')) = '$id'";
