        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="form-group">
                        <label for="">
                            <strong>Enter the previous KPI:</strong>
                        </label>
                        <p><b>Note:</b>&nbsp;<small>This is optional only. If you want to automatically encode the previous KPI, select the year then click OK.</small></p>
                        <div class="input-group">
                            <select class="form-control" id="selectYearPrevious"></select>
                            <div class="input-group-btn">
                                <button class="btn btn-success btn-sm" id="btnEnterPreviousKPI">Ok</button>
                            </div>
                        </div>
                    </div>
                </div>
