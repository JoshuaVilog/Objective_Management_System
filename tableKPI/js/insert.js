...
$("#btnSubmit").click(function(){
    ...
    // let year = JSON.parse(localStorage.getItem(lsActiveYear)).RID;
...
$("#btnEnterPreviousKPI").click(function(){
    let year = $("#selectYearPrevious").val();
    let user = $("#hiddenDisplayUserFullName").val();

    $.ajax({
        type: 'POST',
        url: 'ajax/setPreviousKPI.php',
        data: {
            year: year,
            user: user,
        },
        success: function(kpiID) {
                    ...
                    success: function(data) {
                        ...
                        data.forEach(function(value) {
                            ...
                            var newRowData = {
                                ...
                                id: noCreateKPI,
                                d: noCreateKPI,
                                b: (value['c'] != undefined) ? value['c'] : "",
                                e: (value['f'] != undefined) ? value['f'] : "",
                                c: (value['d'] != undefined) ? value['d'] : "",
                                f: (value['e'] != undefined) ? value['e'] : "",
                                lastS: (value['resultS'] != undefined) ? value['resultS'] : "",
                                lastG: (value['resultG'] != undefined) ? value['resultG'] : "",
