                            ...
                            <div class="col-xs-6 col-sm-12 pricing-box">
                                <div class="widget-box widget-color-orange">
                                    <div class="widget-header">
                                        <h5 class="widget-title bigger lighter">Project List</h5>
                                    </div>
                                    <div class="widget-body">
                                        ...
                                        <!-- <i class="ace-icon fa fa-spinner fa-spin text-primary bigger-125" style="margin: 50px" id="spinnerProjectTable"></i> -->
