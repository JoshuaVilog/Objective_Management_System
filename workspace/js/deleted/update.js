...
function setUpdateCategory(id){
    ...
    $.ajax({
        url: 'ajax/setUpdateCategory.php', 
        type: 'POST',
        data:{
            id: id,
            userCode: userCode,
...
function setUpdateActivity(id){
    ...
    $.ajax({
        url: 'ajax/setUpdateActivity.php', 
        type: 'POST',
        data:{
            id: id,
            userCode: userCode,
...
$("#txtDisplayTaskDetails").blur(function(){
    ...
    $.ajax({
        url: 'ajax/updateTaskDetails.php', 
        type: 'POST',
        data:{
            desc: desc,
            taskID: taskID,
...
$("#selectDisplayTaskAssignee").change(function(){
    ...
    $.ajax({
        url: 'ajax/updateTaskAssignee.php', 
        type: 'POST',
        data:{
            assignees: assignees,
            taskID: taskID,
    ...
    //   $(this).val(lastSelectedOption).trigger('change');
    // }
...
$("#selectDisplayTaskPriority").change(function(){
    ...
    // console.log(value)
    $.ajax({
        url: 'ajax/updateTaskPriority.php', 
        type: 'POST',
        data:{
            desc: value,
            taskID: taskID,
...
$("#txtDisplayTaskDueDate").change(function(){
    ...
    $.ajax({
        url: 'ajax/updateTaskDueDate.php', 
        type: 'POST',
        data:{
            desc: value,
            taskID: taskID,
...
$("#txtDisplayTaskStartDate").change(function(){
    ...
    // console.log(value)
    $.ajax({
        url: 'ajax/updateTaskStartDate.php', 
        type: 'POST',
        data:{
            desc: value,
            taskID: taskID,
...
$("#txtDisplayTaskFinishDate").change(function(){
    ...
    // console.log(value)
    $.ajax({
        url: 'ajax/updateTaskFinishDate.php', 
        type: 'POST',
        data:{
            desc: value,
            taskID: taskID,
...
$("#containerComment").on('click', '.txtDisplayComment', function(){
    ...
    inputElement.on('blur', function() {
        ...
        $.ajax({
            url: 'ajax/updateTaskComment.php', 
            type: 'POST',
            data:{
                desc: newText,
                commentID: commentID,
