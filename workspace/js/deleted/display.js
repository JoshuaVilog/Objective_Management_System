...
function displayTaskInfo(taskID){
    $.ajax({
        url: 'ajax/getTaskInfo.php', // Replace with your server-side script URL
        type: 'POST',
        data:{
            taskID: taskID
        },
...
function displaySubtask(activityID, taskID){
    $.ajax({
        url: 'ajax/getSubtask.php', // Replace with your server-side script URL
        type: 'POST',
        data:{
            activityID: activityID,
            taskID: taskID
...
function displayActionItem(subtaskID){
    // console.log(taskID);
    $.ajax({
        url: 'ajax/getActionItem.php', // Replace with your server-side script URL
        type: 'POST',
        data:{
            subtaskID: subtaskID
        },
...
function displayTaskComment(taskID){
    $.ajax({
        url: 'ajax/getTaskComment.php', // Replace with your server-side script URL
        type: 'POST',
        data:{
            taskID: taskID
        },
...
function displayTaskActivityHistory(taskID){
    ...
    $.ajax({
        url: 'ajax/getTaskActivityHistory.php', // Replace with your server-side script URL
        type: 'POST',
        data:{
            taskID: taskID
        },
