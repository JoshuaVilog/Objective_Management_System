...
$sql = "SELECT `RID`, `ACTIVITY_ID`, `TASK_PARENT_ID`, `TASK_DESC`, `TASK_DETAILS`,`TASK_ASSIGNEE`, `DUE_DATE`, `PRIORITY_ID`, `STATUS`, `START_DATE`, `FINISH_DATE` FROM `task_masterlist` WHERE CONCAT(SUBTASK_PARENT_ID, TASK_PARENT_ID, COALESCE(DELETED_BY, '')) = 0$id ORDER BY CREATED_AT DESC";
