...
$sql = "SELECT `RID`, `ACTIVITY_ID`, `TASK_PARENT_ID`, `SUBTASK_PARENT_ID`, `TASK_DESC`, `TASK_DETAILS`,`TASK_ASSIGNEE`, `DUE_DATE`, `PRIORITY_ID`, `STATUS`, `START_DATE`, `FINISH_DATE` FROM `task_masterlist` WHERE CONCAT(TASK_PARENT_ID, ACTIVITY_ID, COALESCE(DELETED_AT, '')) = '$id' ORDER BY CREATED_AT DESC";
