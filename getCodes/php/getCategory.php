...
$sql = "SELECT `RID`, `CATEGORY_DESC`, CONCAT(WORKSPACE_ID, COALESCE(DELETED_BY, '')) FROM `category_masterlist` WHERE CONCAT(WORKSPACE_ID, COALESCE(DELETED_AT, '')) = $id ORDER BY CREATED_AT DESC";
